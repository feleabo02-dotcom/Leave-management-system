    ...
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
        <div class="p-4 border-b border-gray-100 flex items-center justify-between gap-4 bg-gray-50">
            ...
            <div class="flex items-center gap-2">
                <button class="p-2 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-100 bg-white">
                    ...
                    @forelse($employees as $employee)
                        <tr class="hover:bg-gray-50 transition group">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @else
                                    <span class="px-2 py-1 text-xs font-medium bg-red-100 text-red-700 rounded-full">{{ ucfirst($employee->status) }}</span>
                                @endif
                            </td>
